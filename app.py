...
app = Flask(__name__)
app.config["SECRET_KEY"] = '16c749724f0c2920edea51b1b4e7af80f9a10f2ed97981830c0c9109f2370862'
...
def login():
    form = LoginForm()
    if form.validate_on_submit():
        if form.email.data == "tarek@gmail.com" and form.password.data == "T123!!@tt":
...
# Define your models outside of the routes
class User(db.Model):
...
if __name__ == "__main__":
    with app.app_context():
        db.create_all()  # Ensure this is wrapped in the app context
    app.run(debug=True)
